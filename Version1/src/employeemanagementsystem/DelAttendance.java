...
public class DelAttendance extends javax.swing.JFrame {
    ...
    private void DeleteAttendanceBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteAttendanceBActionPerformed
        try{
                ...
                String updateQuery = "delete from employee_attendance where id ="+id;
    ...
    private void SearchBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBActionPerformed
       ...
       try{
           int id = Integer.parseInt(IDTF.getText());
           Statement stmt = conn.createStatement();
           String selectEmployees = "select a.id,b.name, a.attendance_date,a.check_in_time, a.check_out_time from employee_attendance a inner join employee_info b on a.employee_info_id = b.id where a.id="+id;
           ResultSet rs = stmt.executeQuery(selectEmployees);
           int size = 0;
           while (rs.next()) {
                 size++;
                 NameTF.setText(rs.getString("name"));
                 DateTF.setText(rs.getString("attendance_date"));
                 TimeInTF.setText(rs.getString("check_in_time"));
                 TimeOutTF.setText(rs.getString("check_out_time"));
