...
public class UpdateAttendance extends javax.swing.JFrame {
    ...
    private void UpdateEmployeeBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateEmployeeBActionPerformed
          ...
          try{
                ...
                EMSAttendance.getInstance().editAttendace(id,  name,  date,  timeIn,  timeOut);
                Statement stmt = conn.createStatement();
                String updateQuery = "update employee_attendance set attendance_date = '"+date+"',check_in_time='"+timeIn+"',check_out_time='"+timeOut+"' where id ="+id;
