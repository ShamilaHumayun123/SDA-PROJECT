...
public class UpdateEmployee extends javax.swing.JFrame {
    ...
    private void UpdateEmployeeBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateEmployeeBActionPerformed
       try{
        ...
        String updateQuery = "update employee_info set mobile_no = '"+mobileNo+"',basic_salary='"+salary+"',address='"+address+"',email='"+email+"',name ='"+name+"' where id ='"+id+"'";
    ...
    private void SearchBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBActionPerformed
        ...
        try{
           int id = Integer.parseInt(IDTF.getText());
           Statement stmt = conn.createStatement();
           String selectEmployees = "select * from employee_info where id ="+id;
           ResultSet rs = stmt.executeQuery(selectEmployees);
           int size = 0;
           while (rs.next()) {
                 size++;
                 NameTF.setText(rs.getString("name"));
                 PhoneTF.setText(rs.getString("mobile_no"));
                 SalaryTF.setText(rs.getInt("basic_salary")+"");
