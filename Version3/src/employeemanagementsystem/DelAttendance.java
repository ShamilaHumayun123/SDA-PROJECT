...
public class DelAttendance extends javax.swing.JFrame {
  private EmployeeAttendanceController controller;
    ...
    private void initComponents() {
        ...
        DeleteAttendanceB.setText("Delete Attendace");
        ...
        jLabel3.setText("DELETE ATTENDANCE");
    ...
    private void DeleteAttendanceBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteAttendanceBActionPerformed
       ...
       try {
            ...
            // Call the controller to delete the attendance
            boolean success = controller.deleteAttendanceById(id);

            if (success) {
                JOptionPane.showMessageDialog(null, "Employee Attendance Deleted");
                clearAll();
            } else {
                JOptionPane.showMessageDialog(null, "Failed to Delete Employee Attendance. Please try again.");
            }
        } catch (Exception ex) {
            ex.printStackTrace();
   ...
   public void clearAll(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelAttendance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DelAttendance().setVisible(true);
            }
        });
    }
