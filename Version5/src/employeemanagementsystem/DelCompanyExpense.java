 ...
 * @author INN
 */
public class DelCompanyExpense extends javax.swing.JFrame {

    /**
     * Creates new form UpdateEmployee
     */
     private Connection conn;
    public DelCompanyExpense() {
        initComponents();
         try{
    ...
    private void initComponents() {
        ...
        DeleteEmployeeB.setLabel("Delete Expense");
    ...
    private void DeleteEmployeeBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteEmployeeBActionPerformed
        ...
        String deleteEmployee = "delete from expense where id = "+id;
        Statement stmt = conn.createStatement();
        stmt.execute(deleteEmployee);
        JOptionPane.showMessageDialog(null, "Employee Expense Deleted");
        //clearAll();
       }
        catch(Exception ex){
            ex.printStackTrace();
    ...
    private void SearchBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBActionPerformed
        // TODO add your handling code here:
         try{
           int id = Integer.parseInt(IDTF.getText());
           Statement stmt = conn.createStatement();
           String selectEmployees = "select * from expense where id="+id;
           ...
           while (rs.next()) {
                 ...
                 DateTF.setText(rs.getString("expense_date"));
                 AmountTF.setText(rs.getString("expense_amount"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelCompanyExpense.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DelCompanyExpense().setVisible(true);
            }
        });
    }
