 ...
 * @author INN
 */
public class UpdateBonus extends javax.swing.JFrame {
private EmployeeBonusController controller;
    ...
    private void initComponents() {
        ...
        UpdateEmployeeB.setText("Update Bonus");
    ...
    private void UpdateEmployeeBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateEmployeeBActionPerformed
         ...
         try {
            ...
            int id = Integer.parseInt(IDTF.getText());   // Get bonus ID
            String detail = DetailTF.getText();   // Get bonus description
            String date = DateTF.getText();   // Get bonus date

            // Call controller to update the bonus
            boolean success = controller.updateBonus(id, name, detail, date);

            if (success) {
                JOptionPane.showMessageDialog(null, "Bonus Updated Successfully");
            } else {
                JOptionPane.showMessageDialog(null, "Failed to Update Bonus. Please try again.");
            }
        } catch (Exception ex) {
            ex.printStackTrace();
...
public void clearAll(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateBonus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateBonus().setVisible(true);
            }
        });
    }
