 ...
 * @author INN
 */
public class UpdateLeaves extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        UpdateEmployeeB.setText("Update Leave");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(StatusTF, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(47, 47, 47))
        );
    ...
    private void UpdateEmployeeBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateEmployeeBActionPerformed
          ...
          try {
                    ...
                    if (controller.updateLeave(id, startDate, endDate, status)) {
                        JOptionPane.showMessageDialog(null, "Employee Leave Updated Successfully");
                        clearAll();
                    } else {
                        JOptionPane.showMessageDialog(null, "Failed to Update Leave");
                    }
                } catch (Exception ex) {
    ...
    private void SearchBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBActionPerformed
        // TODO add your handling code here:
          try {
                    int id = Integer.parseInt(IDTF.getText());
                    Map<String, String> leaveData = controller.getLeaveById(id);

                    if (!leaveData.isEmpty()) {
                        NameTF.setText(leaveData.get("name"));
                        StartDateTF.setText(leaveData.get("leave_start_date"));
                        EndDateTF.setText(leaveData.get("leave_end_date"));
                        StatusTF.setText(leaveData.get("status"));
                    } else {
...
public void clearAll(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateLeaves.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateLeaves().setVisible(true);
            }
        });
    }
